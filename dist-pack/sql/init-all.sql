-- ============================================================
-- YQSX 项目数据库一键初始化脚本
-- 包含全部 4 个数据库：shop-product / shop-order / shop_payment / shop_user
-- 已合并：init.sql + alter_decimal_precision.sql + alter_unique_constraints.sql
--        + schema-user-sms-migration.sql + phase3-payment-mysql.sql
-- 注意：t_user 表 admin 账号由 shop-user-service 首次启动时自动创建（密码 123456）
-- ============================================================
...
-- 初始化 19 个 YOLO 零食类别（仅首次插入）
INSERT IGNORE INTO `t_product_category` (`id`, `name`, `display_name`, `yolo_class_id`, `description`, `sort_order`, `status`) VALUES
...
INSERT IGNORE INTO `t_product` (`id`, `name`, `price`, `stock`, `category_id`, `image_url`, `sales`) VALUES
(1, 'Ashi Mashi 经典零食', 12.90, 500, 1, '/images/products/ashi-mashi-snacks.jpg', 120),
(2, 'Chee pellet 番茄酱味', 8.50, 800, 2, '/images/products/chee-pellet-ketchup.jpg', 230),
(3, 'Chee pellet 醋味', 8.50, 700, 3, '/images/products/chee-pellet-vinegar.jpg', 180),
(4, 'Cheetoz 辣椒味薯片', 10.00, 600, 4, '/images/products/cheetoz-chili-chips.jpg', 340),
(5, 'Cheetoz 番茄酱味薯片', 10.00, 650, 5, '/images/products/cheetoz-ketchup-chips.jpg', 410),
(6, 'Cheetoz 洋葱香菜味薯片', 10.50, 500, 6, '/images/products/cheetoz-onion-parsley-chips.jpg', 290),
(7, 'Cheetoz 咸味薯片', 9.50, 900, 7, '/images/products/cheetoz-salty-chips.jpg', 520),
(8, 'Cheetoz 零食 30g', 5.00, 1200, 8, '/images/products/cheetoz-snack-30g.jpg', 880),
(9, 'Cheetoz 零食 90g', 12.00, 800, 9, '/images/products/cheetoz-snack-90g.jpg', 760),
(10, 'Cheetoz 醋味薯片', 10.00, 550, 10, '/images/products/cheetoz-vinegar-chips.jpg', 310),
(11, 'Cheetoz 车轮零食', 11.50, 600, 11, '/images/products/cheetoz-wheelsnack.jpg', 270),
(12, 'Maz Maz 番茄酱味薯片', 9.80, 700, 12, '/images/products/maz-maz-ketchup-chips.jpg', 330),
(13, 'Maz Maz 土豆条', 8.80, 850, 13, '/images/products/maz-maz-potato-sticks.jpg', 450),
(14, 'Maz Maz 咸味薯片', 9.50, 720, 14, '/images/products/maz-maz-salty-chips.jpg', 380),
(15, 'Maz Maz 醋味薯片', 9.80, 680, 15, '/images/products/maz-maz-vinegar-chips.jpg', 300),
(16, 'Mini Lina 饼干', 7.50, 1000, 16, '/images/products/mini-lina.jpg', 620),
(17, 'Minoo 奶油饼干', 8.00, 900, 17, '/images/products/minoo-cream-biscuit.jpg', 540),
(18, 'Naderi 迷你曲奇', 9.00, 750, 18, '/images/products/naderi-mini-cookie.jpg', 470),
(19, 'Naderi 迷你威化', 9.50, 800, 19, '/images/products/naderi-mini-wafer.jpg', 430);

-- ============================================================
-- 2. shop-order 订单库（含 order_no 唯一约束 + version 乐观锁 + 时间字段）
-- ============================================================
...
CREATE TABLE IF NOT EXISTS `t_order` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `order_no` varchar(32) NOT NULL DEFAULT '' COMMENT '订单号（业务唯一标识）',
  `uid` bigint DEFAULT NULL COMMENT '用户id',
...
-- ============================================================
-- 3. shop_payment 支付库（含 transaction_no 唯一约束）
-- ============================================================
CREATE DATABASE IF NOT EXISTS `shop_payment` DEFAULT CHARACTER SET utf8mb4;
USE `shop_payment`;
...
-- ============================================================
-- 4. shop_user 用户库（含 phone 唯一索引 + 短信验证码表）
-- 注意：admin 账号由 shop-user-service 首次启动时自动创建（用户名 admin / 密码 123456）
-- ============================================================
...
-- ============================================================
-- 初始化完成
-- 验证：SELECT COUNT(*) FROM shop-product.t_product;  应返回 19
-- ============================================================
